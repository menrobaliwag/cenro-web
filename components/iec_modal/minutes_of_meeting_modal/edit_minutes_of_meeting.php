<div class="modal fade modal-ux" id="editMinutesModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <form action="<?= url_with_base('modules/iec/minutes_update.php') ?>" method="POST" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <div class="w-100 d-flex align-items-start justify-content-between">
            <div>
              ...
              <div class="modal-subtitle">Update the minutes details below.</div>
            </div>
        ...
        <div class="modal-body">
          <input type="hidden" name="id" id="editMinId">
          <div class="row g-3">
            ...
            <?php if ($isHeadAdmin || $isIecAdmin): ?>
              <div class="col-md-6">
                ...
                <div class="input-icon">
                  ...
                  <input type="text" class="form-control" name="barangay" id="editMinBarangay" required>
                </div>
              </div>
            <?php endif; ?>
            ...
            <div class="col-md-3">
              ...
              <div class="input-icon">
                ...
                <select class="form-select" name="quarter" id="editMinQuarter" required>
            ...
            <div class="col-md-3">
              ...
              <div class="input-icon">
                ...
                <input type="number" class="form-control" name="year" id="editMinYear" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-icon">
                ...
                <input type="date" class="form-control" name="meeting_date" id="editMinMeetingDate" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-icon">
                ...
                <input type="text" class="form-control" name="prepared_by" id="editMinPreparedBy" required>
              </div>
            </div>
            ...
            <?php if ($isHeadAdmin || $isIecAdmin): ?>
              <div class="col-md-6">
                ...
                <div class="input-icon">
                  ...
                  <select class="form-select" name="submission_status" id="editMinStatus" required>
            ...
            <div class="col-12">
              <label class="ux-label"><i class="fa fa-paperclip"></i> Replace PDF (optional)</label>
              <input type="file" class="form-control" name="minutes_pdf" accept=".pdf">
            </div>

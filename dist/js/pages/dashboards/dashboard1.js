...
$(function() {
    ...
    var chart = new Chartist.Line('.sales', {
        ...
        fullWidth: true,
        plugins: [
            // ✅ Safely use plugin only if it exists
            Chartist.plugins && Chartist.plugins.tooltip ? Chartist.plugins.tooltip() : undefined
        ].filter(Boolean),
        axisY: {
            onlyInteger: true,
            scaleMinSpace: 40,
